...
public class Backup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Student Fingerprint Register2");
        ...
        fingerprintImage = (ImageView)findViewById(R.id.img_fingerprint);
    ...
    private void checkDeviceFingerprintSupport() {
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.USE_FINGERPRINT) != PackageManager.PERMISSION_GRANTED) {
            ...
            if (!fingerprintManager.isHardwareDetected()) {
                Toast.makeText(RegisterActivity3333.this, "Fingerprint is not supported in this device", Toast.LENGTH_LONG).show();
            }
            if (!fingerprintManager.hasEnrolledFingerprints()) {
                Toast.makeText(RegisterActivity3333.this, "Fingerprint not yet configured", Toast.LENGTH_LONG).show();
            }
            if (!keyguardManager.isKeyguardSecure()) {
                Toast.makeText(RegisterActivity3333.this, "Screen lock is not secure and enable", Toast.LENGTH_LONG).show();
            }
            return;
        }
    }
    ...
    public static class FingerprintHandler extends FingerprintManager.AuthenticationCallback{
        ...
        public void onAuthenticationSucceeded(FingerprintManager.AuthenticationResult result) {
            ...
            if(mUser != null){
                ...
                Intent userIntent = new Intent(context, SignUpActivity.class);
                context.startActivity(userIntent);
